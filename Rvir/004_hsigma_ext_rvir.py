...
ax1.plot(s_bins,np.log10(f_integral_model), label='seppi20',linewidth=4,c='C0')
ax1.plot(s_bins,np.log10(mf_comparat),label='comparat17',linewidth=2,c='k',linestyle='dashed')
