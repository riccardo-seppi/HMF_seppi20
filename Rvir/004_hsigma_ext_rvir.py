...
plt.ylim(-5,0)
#plt.xlim(-3.5,0.)
plt.ylabel(r'$\log_{10}g_{\lambda}(\sigma,X_{off})$', fontsize=20)
...
plt.ylim(-5,0)
#plt.xlim(-3.5,0.)
plt.ylabel(r'$\log_{10}g_{X_{off}}(\sigma,\lambda)$', fontsize=20)
...
plt.legend(fontsize=15)
plt.ylabel(r'$\log_{10}g_{\sigma}(X_{off},\lambda)$', fontsize=20)
plt.xlabel(r'$\log_{10}X_{off}$',fontsize=20)
plt.tick_params(labelsize=15)
plt.ylim(-5,0)
plt.grid(True)
...
ax1.set_ylabel(r'$\log_{10}f_{\sigma,\lambda}(X_{off})$', fontsize=20)
...
ax1.legend(fontsize=15)
ax1.set_ylabel(r'$\log_{10}f_{\sigma,X_{off}}(\lambda)$', fontsize=20)
ax2.set_ylabel(r'$\Delta\log_{10}f$', fontsize=20)
...
ax1.set_ylabel(r'$\log_{10}f_{X_{off},\lambda}(\sigma)$', fontsize=20)
