...
bestfit = os.path.join('/home','rseppi','HMF_seppi20','Rvir','results','z_0.000','hsigma_params_Rvir.fit')
zevo = os.path.join('/home','rseppi','HMF_seppi20','Rvir','results','zevo','hsigma_params_Rvir.fit')
...
ax9 = fig.add_subplot(gs[4,1:3])
ax1 = fig.add_subplot(gs[0,:2],sharex=ax9)
ax2 = fig.add_subplot(gs[1,:2],sharex=ax9)
ax3 = fig.add_subplot(gs[2,:2],sharex=ax9)
ax4 = fig.add_subplot(gs[3,:2],sharex=ax9)
ax5 = fig.add_subplot(gs[0,2:],sharex=ax9)
ax6 = fig.add_subplot(gs[1,2:],sharex=ax9)
ax7 = fig.add_subplot(gs[2,2:],sharex=ax9)
ax8 = fig.add_subplot(gs[3,2:],sharex=ax9)
'''
...
ax8.legend(fontsize=15, loc = 'lower right')
...
fig.tight_layout()
outf = os.path.join('/home','rseppi','HMF_seppi20','Rvir','results','zevo','parameters_redshift_plot_Rvir.png')
