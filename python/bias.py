...
M = np.logspace(12,16,100)
z = np.array([0.0,0.2,0.5,1.0,2.0,5.0])


outfig = os.path.join('/home/rseppi/HMF_seppi20','figures','bias.png')
plt.figure(figsize=(6,6))

for z_ in z:
    b = bias.haloBias(M, model = 'tinker10', z = z_, mdef = '500c')
    plt.plot(M,b, label='z={:.1f}'.format(z_))

plt.xlabel(r'M500c [M$_\odot$/h]', fontsize=13)
