...
plt.ylim(-5,0)
#plt.xlim(-3.5,0.)
plt.ylabel(r'$\log_{10}g_{\lambda}(\sigma,X_{off,P})$', fontsize=12)
...
plt.ylim(-5,0)
#plt.xlim(-3.5,0.)
plt.ylabel(r'$\log_{10}g_{X_{off,P}}(\sigma,\lambda)$', fontsize=12)
...
plt.legend(fontsize=10)
plt.ylabel(r'$\log_{10}g_{\sigma}(X_{off,P},\lambda)$', fontsize=12)
plt.xlabel(r'$\log_{10}X_{off,P}$',fontsize=12)
plt.tick_params(labelsize=12)
plt.ylim(-5,0)
plt.grid(True)
...
ax1.set_ylabel(r'$\log_{10}f_{\sigma,\lambda}(X_{off,P})$', fontsize=12)
ax2.set_xlabel(r'$\log_{10}X_{off,P}$',fontsize=12)
...
ax1.legend(fontsize=10)
ax1.set_ylabel(r'$\log_{10}f_{\sigma,X_{off,P}}(\lambda)$', fontsize=12)
ax2.set_ylabel(r'$\Delta\log_{10}f$', fontsize=12)
...
ax1.set_ylabel(r'$\log_{10}f_{X_{off,P},\lambda}(\sigma)$', fontsize=24)
