...
plt.ylim(-5,0)
#plt.xlim(-3.5,0.)
plt.ylabel(r'$\log_{10}$g$_{\lambda}$($\sigma$,X$_{\rm off,P}$)', fontsize=12)
plt.xlabel(r'$\log_{10}$X$_{\rm off,P}$', fontsize=12)
#plt.grid(True)
plt.tight_layout()
...
#    yerr=1/np.log(10)*g_sigma_xoff_err[:,j]/g_sigma_xoff[:,j] #get log error
    ...
    plt.fill_between(s_bins,np.log10(g_sigma_xoff[:,j])-yerr,np.log10(g_sigma_xoff[:,j])+yerr,alpha=0.4,label=r'X$_{\rm off,P}$ = %.3g'%(label))
...
plt.ylim(-5,0)
#plt.xlim(-3.5,0.)
plt.ylabel(r'$\log_{10}$g$_{X_{\rm off,P}}$($\sigma$,$\lambda$)', fontsize=12)
...
plt.legend(fontsize=10)
plt.ylabel(r'$\log_{10}$g$_{\sigma}$(X$_{\rm off,P}$,$\lambda$)', fontsize=12)
plt.xlabel(r'$\log_{10}$X$_{\rm off,P}$',fontsize=12)
plt.tick_params(labelsize=12)
plt.ylim(-5,0)
#plt.grid(True)
...
#    yerr=1/np.log(10)*g_xoff_spin_err[j,:]/g_xoff_spin[j,:] #get log error
    yerr=1/np.log(10)*err_g_xoff_spin[j,:]/g_xoff_spin[j,:]
    label = 10**xoff_bins[j]
    plt.fill_between(spin_bins,np.log10(g_xoff_spin[j,:])-yerr,np.log10(g_xoff_spin[j,:])+yerr,alpha=0.4,label=r'X$_{\rm off,P}$ = %.3g'%(label))
...
ax1.fill_between(xoff_bins,np.log10(f_xoff)-yerr,np.log10(f_xoff)+yerr, label=r'f(X$_{\rm off,P}$) data',alpha=0.8)
ax2.fill_between(xoff_bins,rat-yerr,rat+yerr,alpha=0.8)
ax2.hlines(0,min(xoff_bins),max(xoff_bins))
ax1.plot(xoff_bins,np.log10(f_xoff_model), label=r'f(X$_{\rm off,P}$) model',linewidth=3, color = 'red')
ax1.legend(fontsize=10)
ax1.set_ylabel(r'$\log_{10}$f$_{\sigma,\lambda}$(X$_{\rm off,P}$)', fontsize=12)
ax2.set_xlabel(r'$\log_{10}$X$_{\rm off,P}$',fontsize=12)
...
ax1.legend(fontsize=10)
ax1.set_ylabel(r'$\log_{10}$f$_{\sigma,X_{\rm off,P}}$($\lambda$)', fontsize=12)
ax2.set_ylabel(r'$\Delta\log_{10}$f', fontsize=12)
...
ax1_sec.plot([],[])
ax1_sec.set_xlabel(r'$\log_{10}$M [M$_{\odot}$/h]', fontsize=24, labelpad=15)
...
ax1.set_ylabel(r'$\log_{10}$f$_{X_{\rm off,P},\lambda}$($\sigma$)', fontsize=24)
