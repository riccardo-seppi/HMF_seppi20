...
ax1.fill_between(bins_conc,pdf_conc0-yerr_conc0+0.3,pdf_conc0+yerr_conc0+0.3, label = r'%.3g < M$_\odot$/h $\leq$ %.3g'%(mass_interval[0],mass_interval[1]), alpha=0.5)
ax1.plot(bins_conc,modified_sch_list([bins_conc,sig_bins[0]],*popt_pdf_conc_list)+0.3)
ax1.fill_between(bins_conc,pdf_conc1-yerr_conc1+0.2,pdf_conc1+yerr_conc1+0.2, label = r'%.3g < M$_\odot$/h $\leq$ %.3g'%(mass_interval[1],mass_interval[2]), alpha=0.5)
ax1.plot(bins_conc,modified_sch_list([bins_conc,sig_bins[1]],*popt_pdf_conc_list)+0.2)
ax1.fill_between(bins_conc,pdf_conc2-yerr_conc2+0.1,pdf_conc2+yerr_conc2+0.1, label = r'%.3g < M$_\odot$/h $\leq$ %.3g'%(mass_interval[2],mass_interval[3]), alpha=0.5)
ax1.plot(bins_conc,modified_sch_list([bins_conc,sig_bins[2]],*popt_pdf_conc_list)+0.1)
ax1.fill_between(bins_conc,pdf_conc3-yerr_conc3,pdf_conc3+yerr_conc3, label = r'%.3g < M$_\odot$/h $\leq$ %.3g'%(mass_interval[3],mass_interval[4]), alpha=0.5)
ax1.plot(bins_conc,modified_sch_list([bins_conc,sig_bins[3]],*popt_pdf_conc_list))
ax1.fill_between(bins_conc,pdf_conc4-yerr_conc4-0.1,pdf_conc4+yerr_conc4-0.1, label = r'%.3g < M$_\odot$/h $\leq$ %.3g'%(mass_interval[4],mass_interval[5]), alpha=0.5)
ax1.plot(bins_conc,modified_sch_list([bins_conc,sig_bins[4]],*popt_pdf_conc_list)-0.1)
ax1.fill_between(bins_conc,pdf_conc5-yerr_conc5-0.2,pdf_conc5+yerr_conc5-0.2, label = r'%.3g < M$_\odot$/h $\leq$ %.3g'%(mass_interval[5],mass_interval[6]), alpha=0.5)
...
ax1.set_ylabel(r'$\log_{10}$P(c)+C$_0$',fontsize=12)
...
#ax3.grid(True)
ax3.set_xlabel(r'c = R$_{\rm vir}$/R$_{\rm s}$',fontsize=12)
ax3.set_ylabel(r'$\log_{10}$P(c)+C$_0$',fontsize=12)
...
#ax4.grid(True)
ax4.set_xlabel(r'c = R$_{\rm vir}$/R$_{\rm s}$',fontsize=12)
